...
public class DashboardActivityCoach extends AppCompatActivity {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            ...
                            case R.id.nav_profile_coach:
                                ...
                                actionBar.setTitle("Coach profile");//change action bar title
                                CoachProfileFragment fragment2 = new CoachProfileFragment();
                                FragmentTransaction ft2 = getSupportFragmentManager().beginTransaction();
                                ft2.replace(R.id.content, fragment2, "");
                                ft2.commit();
    ...
    private void checkUserStatus(){
        ...
        if (user!=null) {
            ...
            startActivity(new Intent(DashboardActivityCoach.this,MainActivity.class));
            finish();
