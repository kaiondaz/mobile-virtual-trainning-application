...
import com.example.myapp.Client_profile_Coach;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

public class AdapterClientsCoach extends RecyclerView.Adapter<AdapterClientsCoach.MyViewHolder> {

    Context context;
    ArrayList<Client2> Clients;

    public AdapterClientsCoach(Context c, ArrayList<Client2> clients) {
        context = c;
        Clients = clients;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.ViewClientProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, Client_profile_Coach.class);
