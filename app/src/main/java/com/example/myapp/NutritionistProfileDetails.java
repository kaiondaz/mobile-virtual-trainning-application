...
public class NutritionistProfileDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nutritionist_profile_details);
        ...
        databaseReferenceName = firebaseDatabase.getReference("Nutritionists").child(currentUserID).child("name");
        databaseReferenceAddress = firebaseDatabase.getReference("Nutritionists").child(currentUserID).child("address");
        databaseReferencePhone = firebaseDatabase.getReference("Nutritionists").child(currentUserID).child("phone");
        ...
        AvatarIv=findViewById(R.id.profilePicTv3);
            ...
            public void onClick (View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                ...
                                                                Toast.makeText(NutritionistProfileDetails.this, client.getName()+" you have updated your details.", Toast.LENGTH_LONG).show();
