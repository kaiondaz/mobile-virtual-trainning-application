...
public class CoachClients extends AppCompatActivity {

   DatabaseReference reference;
   RecyclerView recyclerView;
   ArrayList<Client2> list;
   AdapterClientsCoach adapter;
   FirebaseAuth auth;
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(CoachClients.this));
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
...

                {
                    ...
                    if(client.getCoachID().equals(id)){
                    list.add(client);
                    }}
                }

                adapter= new AdapterClientsCoach(CoachClients.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(CoachClients.this,"Can't connect to the database.",Toast.LENGTH_SHORT).show();
