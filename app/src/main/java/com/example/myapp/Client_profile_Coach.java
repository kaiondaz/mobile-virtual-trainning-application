...
public class Client_profile_Coach extends AppCompatActivity {

    //Fields
    String hisUID;
    Button viewWorkoutsBtn,viewNutritionBtn,addWorkoutsBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client_profile_coach);
        ...
        //Init Buttons
        viewWorkoutsBtn = (Button) findViewById(R.id.viewWorkouts);
        viewNutritionBtn= (Button) findViewById(R.id.addReviewBtn);
        addWorkoutsBtn = (Button) findViewById(R.id.addWorkoutsBtn);

        //Init text views
        ClientUsernameTv = (TextView) findViewById(R.id.nutritionistNameTv);
        ...
        addWorkoutsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent myIntent = new Intent(Client_profile_Coach.this, Create_Workouts.class);
                // myIntent.putExtra("key", value); //Optional parameters
                myIntent.putExtra("nutritionistID", hisUID);
                Client_profile_Coach.this.startActivity(myIntent);
            ...
            viewWorkoutsBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent myIntent = new Intent(Client_profile_Coach.this, ClientWorkoutPlans.class);
