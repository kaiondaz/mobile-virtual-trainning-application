...
public class DashboardActivityAdmin extends AppCompatActivity {
                ...
                new BottomNavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            ...
                            case R.id.addUsers:
                                //users fragment transaction
                                actionBar.setTitle("Add coach or nutritionist");//change action bar title
                                AddUserFragment fragment6 = new AddUserFragment();
    ...
    private void checkUserStatus(){
        ...
        if (user!=null) {
            ...
            startActivity(new Intent(DashboardActivityAdmin.this,MainActivity.class));
            finish();
