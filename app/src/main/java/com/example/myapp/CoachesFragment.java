...
public class CoachesFragment extends Fragment {
    ...
    private void getAllusers() {
        ...
        DatabaseReference ref2 = FirebaseDatabase.getInstance().getReference("Coaches");
        final DatabaseReference coachesRef = FirebaseDatabase.getInstance().getReference("Coaches");
        ...
        ref2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    coachesList.add(modelClient2);
                    //}

                    //adapter
                    adapterCoaches= new AdapterCoaches(getActivity(), coachesList, userEmail,coachesRef,userID);
                    recyclerview.setAdapter(adapterCoaches);
    ...
    private void searchUsers( final String query) {
        ...
        //Get path of database named  containing users info
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Coaches");
        final DatabaseReference coachesRef = FirebaseDatabase.getInstance().getReference("Coaches");
