    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Mydetails.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick (View view) {
                ...
                Intent myIntent = new Intent(getActivity(), CoachProfileDetails.class);
                myIntent.putExtra("coach", userType);
                CoachProfileFragment.this.startActivity(myIntent);
        ...
        MyClients.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(getActivity(),CoachClients.class);
