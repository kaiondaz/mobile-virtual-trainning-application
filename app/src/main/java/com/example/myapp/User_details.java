...
public class User_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReferenceName = firebaseDatabase.getReference("Clients").child(currentUserID).child("name");
        databaseReferenceAddress = firebaseDatabase.getReference("Clients").child(currentUserID).child("address");
        databaseReferencePhone = firebaseDatabase.getReference("Clients").child(currentUserID).child("phone");
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                ...
                                                                Toast.makeText(User_details.this, client.getName() + " you have updated your details.", Toast.LENGTH_LONG).show();
