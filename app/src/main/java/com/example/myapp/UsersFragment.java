...
public class UsersFragment extends Fragment {
    ...
    private void getAllusers() {
        ...
        DatabaseReference ref2 = FirebaseDatabase.getInstance().getReference("Clients");
        final DatabaseReference clientsRef = FirebaseDatabase.getInstance().getReference("Clients");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    //if (!modelClient2.getUID().equals(fUser.getUid())){
                        client2List.add(modelClient2);
                    //}

                    //adapter
                    adapterUsers= new AdapterUsers(getActivity(), client2List, userEmail,clientsRef,userID);
